...
TXT = {
    "ru": {
        ...
        "need_topic": "Напиши всё о песне по пунктам:

1️⃣ Кому посвящается песня?

2️⃣ Расскажи историю о нём/ней, смешные или важные моменты.

3️⃣ Если песня про какое-то мероприятие — что за событие?

4️⃣ Если песня про погоду или природу — расскажи детали.

5️⃣ Что хочется передать этим треком — любовь, радость, благодарность, и т.д.    ",
        "busy": "⏳ Генерирую…",
